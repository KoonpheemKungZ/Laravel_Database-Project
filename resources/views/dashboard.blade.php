<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <b class="float-end">จำนวนผู้ใช้งาน <span>{{count($users)}}</span> คน</b>
        </h2>
    </x-slot>
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          ...
          <img src="https://notebookspec.com/web/pc/pic-pc/cpu/20210317-115233_1.png" class="d-block w-100" alt="...">

            <div class="card-body">
              <p class="card-text">CPU I9-19900K 3.5 GH.</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">View Detail</button>
                </div>
                <small class="text-muted">Price 100000 Baht</small>
              </div>
            </div>
          </div>
        </div>
